<?php include "./include/head_student.php"; ?>
<div class="container">
	<div class="crud-container">
		...
		<ul class="nav nav-tabs">
			...
			<li class="nav-item">
				<a id="nav-docent-account" class="nav-link <?php if (endsWith(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH), "account")) echo "active\" aria-current=\"page"; ?>" href="verantwoording">Verantwoording</a>
			</li>
